...
package goku_fla
{
    ...
    public dynamic class goku_b_243 extends MovieClip 
    {
        ...
        internal function frame145():*
        {
            ...
            if (this.currentCharge < 2)
            {
                this.self.fireProjectile("goku_kame1", 15, -30);
            };
        }
        ...
        internal function frame161():*
        {
            this.self.playVoiceSound(5);
            this.self.playAttackSound(2);
            this.self.fireProjectile("goku_kame2", 15, -30);
        }
        ...
        internal function frame183():*
        {
            this.self.playVoiceSound(5);
            this.self.playAttackSound(2);
            this.self.fireProjectile("goku_kame3", 18, -30);
        }
        ...
        internal function frame209():*
        {
            this.self.playVoiceSound(5);
            this.self.playAttackSound(2);
            this.self.fireProjectile("goku_kame4", 20, -30);
        }
