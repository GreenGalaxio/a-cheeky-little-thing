...
package goku_fla
{
    ...
    public dynamic class ssgoku_ncpecial_591 extends MovieClip 
    {
        ...
        internal function frame145():*
        {
            ...
            this.self.fireProjectile("ssgoku_kame1", 34, -34);
        }
        ...
        internal function frame169():*
        {
            ...
            this.self.playAttackSound(2);
            this.self.fireProjectile("ssgoku_kame2", 34, -34);
        }
        ...
        internal function frame199():*
        {
            ...
            this.self.playVoiceSound(2);
            this.self.playAttackSound(2);
            this.self.fireProjectile("ssgoku_kame3", 34, -34);
        }
        ...
        internal function frame225():*
        {
            ...
            this.self.playVoiceSound(2);
            this.self.playAttackSound(2);
            this.self.fireProjectile("ssgoku_kame3", 40, -34);
        }
