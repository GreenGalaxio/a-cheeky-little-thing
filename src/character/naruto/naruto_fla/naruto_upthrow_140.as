...
package naruto_fla
{
    ...
    public dynamic class naruto_upthrow_140 extends MovieClip 
    {
        ...
        public function naruto_upthrow_140()
        {
            addFrameScript(0, this.frame1, 1, this.frame2, 9, this.frame10, 10, this.frame11, 16, this.frame17, 17, this.frame18, 19, this.frame20, 20, this.frame21, 23, this.frame24, 24, this.frame25, 29, this.frame30, 39, this.frame40);
        }
        ...
        internal function frame10():*
        {
            ...
            {
                SSF2API.playSound("ENG_naruto_heavygrunt1", true);
            }
            else
            {
