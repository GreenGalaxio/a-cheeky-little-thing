...
//chibirobo_fla.chibi_revival_10
...
package chibirobo_fla
{
    ...
    public dynamic class chibi_revival_10 extends MovieClip 
    {

        public var stance:MovieClip;
        public var self:*;

        public function chibi_revival_10()
        {
        ...
        internal function frame1():*
        {
            ...
            if (this.self)
            {
                if (!this.self.getGlobalVariable("telly_timer"))
                {
                    ...
                    SSF2API.print(("Made telly_timer: " + this.self.getClobalVariable("telly_timer")));
                };
            };
        }
