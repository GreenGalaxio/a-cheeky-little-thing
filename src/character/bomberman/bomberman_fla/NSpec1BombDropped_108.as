...
//bomberman_fla.NSpec1BombDropped_108
...
package bomberman_fla
{
    ...
    public dynamic class NSpec1BombDropped_108 extends MovieClip 
    {
        ...
        public function NSpec1BombDropped_108()
        {
            addFrameScript(0, this.frame1, 1, this.frame2, 33, this.frame34, 34, this.frame35, 40, this.frame41, 41, this.frame42, 42, this.frame43, 43, this.frame44, 53, this.frame54, 54, this.frame55, 55, this.frame56, 65, this.frame66);
        }
        ...
        internal function frame2():*
        {
            ...
            SSF2API.createTimer(this.self, 1, -1, this.timeCheck);
            SSF2API.createTimer(this.self, 1, -1, this.landCheck);
        }
        ...
        internal function frame35():*
        {
            ...
            this.projectile.attachEffect("explosionNew");
