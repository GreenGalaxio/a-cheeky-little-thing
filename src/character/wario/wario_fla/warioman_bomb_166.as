...
package wario_fla
{
    ...
    public dynamic class warioman_bomb_166 extends MovieClip 
    {
        ...
        public function warioman_bomb_166()
        {
        ...
        public function toContinue(_arg_1:*):*
        {
            ...
            this.self.attachEffect("warioboom");
            this.self.destroy();
        }
        ...
        internal function frame1():*
        {
            ...
            if (((SSF2API.isReady()) && (this.self)))
            {
                ...
                SSF2API.addEventListener(this.self, SSF2Event.CHAR_SHIELD_HIT, this.toContinue);
