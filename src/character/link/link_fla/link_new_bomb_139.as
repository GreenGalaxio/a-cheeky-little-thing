...
package link_fla
{
    ...
    public dynamic class link_new_bomb_139 extends MovieClip 
    {
        ...
        public function link_new_bomb_139()
        {
        ...
        internal function frame1():*
        {
            ...
            if (((SSF2API.isReady()) && (this.self)))
            {
                ...
                if (this.self.getGlobalVariable("exploding"))
                {
                    this.gotoAndPlay("finish");
                };
