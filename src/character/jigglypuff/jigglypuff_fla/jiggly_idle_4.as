...
package jigglypuff_fla
{
    ...
    public dynamic class jiggly_idle_4 extends MovieClip 
    {
        ...
        public function restOnReaction():void
        {
            if (((this.self.getCPUForcedAction() == -1) || (this.self.getCPUForcedAction() == 5)))
            {
                ...
                if (((((((((((((SSF2API.random() < 0.5) && (!(this.getTarget.getMC().currentLabel == "defend"))) && (!(this.getTarget.getMC().currentLabel == "airdodge"))) && (!(this.getTarget.getMC().currentLabel == "revival"))) && (!(this.self.inUpperRightWarningBounds()))) && (!(this.self.inLowerRightWarningBounds()))) && (!(this.self.inUpperLeftWarningBounds()))) && (!(this.self.inLowerLeftWarningBounds()))) && (this.getTarget.getX() < (this.self.getX() + 10))) && (this.getTarget.getX() > (this.self.getX() - 10))) && (this.getTarget.getY() < (this.self.getY() + 10))) && (this.getTarget.getY() > (this.self.getY() - 10))))
                {
