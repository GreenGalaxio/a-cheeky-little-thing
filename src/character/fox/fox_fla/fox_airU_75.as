...
package fox_fla
{
    ...
    public dynamic class fox_airU_75 extends MovieClip 
    {
        ...
        public function fox_airU_75()
        {
            addFrameScript(0, this.frame1, 1, this.frame2, 2, this.frame3, 3, this.frame4, 4, this.frame5, 5, this.frame6, 13, this.frame14, 14, this.frame15, 15, this.frame16, 20, this.frame21);
        }
        ...
        {
            SSF2API.playSound("brawl_fox_swing_H");
        }
