...
package 
{
    ...
    public dynamic class megaman extends MovieClip 
    {
        ...
        {
            this.xframe = "switchBlock";
            stop();
        }

        internal function frame76():*
        {
            this.xframe = "switchBomb";
            stop();
        }

        internal function frame77():*
        {
            this.xframe = "switchBHB";
            stop();
        }

        internal function frame78():*
        {
            this.xframe = "switchBlade";
            stop();
        }

        internal function frame79():*
        {
            this.xframe = "switchBlock_air";
            stop();
        }

        internal function frame80():*
        {
            this.xframe = "switchBomb_air";
            stop();
        }

        internal function frame81():*
        {
            this.xframe = "switchBHB_air";
            stop();
        }

        internal function frame82():*
        {
            this.xframe = "switchBlade_air";
            stop();
        }
