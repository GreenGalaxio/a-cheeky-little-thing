...
//sonic_fla.supersonic_upair_255
...
package sonic_fla
{
    ...
    public dynamic class supersonic_upair_255 extends MovieClip 
    {
        ...
        public function supersonic_upair_255()
        {
            addFrameScript(0, this.frame1, 4, this.frame5, 11, this.frame12);
        }
        ...
        internal function frame5():*
        {
            ...
            if (((!(root == null)) && (!(parent == null))))
            {
                MovieClip(root).stageData.getPlayer(MovieClip(parent).player_id).modifyAttackPower(1800);
            };
        }
