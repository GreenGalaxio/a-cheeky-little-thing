...
//sonic_fla.supersonic_forwardtilt_246
...
package sonic_fla
{
    ...
    public dynamic class supersonic_forwardtilt_246 extends MovieClip 
    {
        ...
        public function supersonic_forwardtilt_246()
        {
        ...
        internal function frame8():*
        {
            ...
            if (((!(root == null)) && (!(parent == null))))
            {
                MovieClip(root).stageData.getPlayer(MovieClip(parent).player_id).modifyAttackPower(1200);
            };
            if (((!(root == null)) && (!(parent == null))))
            {
