...
//ness_fla.ness_pkfireproj_air_116
...
package ness_fla
{
    ...
    public dynamic class ness_pkfireproj_air_116 extends MovieClip 
    {
        ...
        public function ness_pkfireproj_air_116()
        {
            addFrameScript(0, this.frame1, 3, this.frame4, 4, this.frame5, 5, this.frame6, 52, this.frame53, 60, this.frame61, 61, this.frame62);
        }
        ...
        public function goToAfterHit(_arg_1:*=null):void
        {
            ...
            SSF2API.removeEventListener(this.self, SSF2Event.ATTACK_CONNECT_SHIELD, this.goToAfterHit);
