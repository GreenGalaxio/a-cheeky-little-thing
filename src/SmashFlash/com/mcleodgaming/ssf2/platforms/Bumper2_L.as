package com.mcleodgaming.ssf2.platforms
{
   ...
   public class Bumper2_L extends CNZBumper
   {
       
      
      public function Bumper2_L(param1:MovieClip, param2:StageData)
      {
         super(param1,param2);
      }
         ...
         while(_loc5_ < m_opponents.length)
         {
            ...
            if(_loc2_ != null)
            {
               if(Utils.fastAbs(m_attack.AttackID - _loc2_.PreviousAttackID) > 1 && !_loc2_.IsCaught && _loc1_.intersects(_loc2_.BoundsRect))
               {
                  ...
                  {
                     bouncePlayer(_loc2_,180);
                  }
                  else
                  {
                     bouncePlayer(_loc2_,45);
                  }
               }
            }
            _loc5_++;
