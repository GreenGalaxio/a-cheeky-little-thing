package com.mcleodgaming.ssf2.events
{
   ...
   public class SSF2Event extends Event
   {
      ...
      public static const GROUND_LAND:String = "groundLand";
      ...
      public function SSF2Event(param1:String, param2:Object = null, param3:Boolean = false, param4:Boolean = false)
      {
         super(param1,param3,param4);
         this._data = Boolean(param2)?param2:{};
      }
